Public Class Mantenimiento_Tipos_de_gasto
    Dim SQL As New BackOffice_datos.SQL
    Private Sub Mantenimiento_Tipos_de_gasto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Cargar_datos()
        Configurar_GridControl()
    End Sub

    Private Sub Cargar_datos()
        GridControl.DataSource = SQL.Tabla_con_actualización_de_datos("Select * From Tipos_de_gasto")
    End Sub
    ...
    Private Sub GridView_InitNewRow(sender As Object, e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles GridView.InitNewRow
        GridView.SetRowCellValue(e.RowHandle, "Id_tipo_de_gasto", SQL.Nuevo_ID("Id_tipo_de_gasto", "Tipos_de_gasto"))
    End Sub
