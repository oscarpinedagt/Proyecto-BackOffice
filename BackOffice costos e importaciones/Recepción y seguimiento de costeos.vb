Public Class Recepción_y_seguimiento_de_costeos
    ...
    Private Sub BBI_Cargar_costeos_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BBI_Cargar_costeos.ItemClick
        ...
        If File.ShowDialog() = DialogResult.OK Then
            ...
            Dim Dt_Tecun As DataTable = SQL.Tabla_de_datosXLSX(File.FileName, "Select * From [TECUN, S.A.$]")
            ...
            Dim Dt_Insectrol As DataTable = SQL.Tabla_de_datosXLSX(File.FileName, "Select * From [INSECTROL, S.A.$]")
            ...
            Dim Dt_Vehiculos As DataTable = SQL.Tabla_de_datosXLSX(File.FileName, "Select * From [VEHICULOS$]")
